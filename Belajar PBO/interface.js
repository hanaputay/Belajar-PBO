...
var Kubus = /** @class */ (function () {
    ...
    Kubus.prototype.luasPermukaan = function () {
        console.log("Luas permukaan ".concat(this.nama, " dengan sisi ").concat(this.sisi, " = ").concat(Math.pow(this.sisi, 6), " "));
    };
    return Kubus;
}());
var Balok = /** @class */ (function () {
    ...
    Balok.prototype.luasPermukaan = function () {
        console.log("Luas permukaan ".concat(this.nama, " dengan panjang ").concat(this.panjang, ", lebar ").concat(this.lebar, ", dan tinggi ").concat(this.tinggi, " = ").concat(2 * (this.panjang * this.lebar + this.panjang * this.tinggi + this.lebar * this.tinggi), " "));
    };
    return Balok;
}());
var Tabung = /** @class */ (function () {
    ...
    Tabung.prototype.volume = function () {
        console.log("Volume ".concat(this.nama, " dengan jari ").concat(this.panjang, ", lebar ").concat(this.lebar, ", dan tinggi ").concat(this.tinggi, " = ").concat(this.panjang * this.lebar * this.tinggi));
    };
