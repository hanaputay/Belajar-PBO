...
class Kubus implements Volume, LuasPermukaan{
    ...
    luasPermukaan(): void{
        console.log(`Luas permukaan = ${this.sisi **6} `)
    }
}
...
class Balok implements Volume, LuasPermukaan{
    ...
    luasPermukaan(): void{
        console.log(`Luas permukaan = ${2 * (this.panjang * this.lebar + this.panjang * this.tinggi + this.lebar * this.tinggi)} `)
    }
}
...
class Tabung implements Volume, LuasPermukaan{
    ...
    luasPermukaan(): void{
        console.log(`Luas permukaan = ${2 * 22/7 * this.jari * this.jari + 2 * 22/7 * this.jari * this.tinggi} `)
    }
}
